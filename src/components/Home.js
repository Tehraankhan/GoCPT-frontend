...
export default function Home() {
  ...
  return (
    ...
    <div id="Home" className={`text-white W-[100%] border-[1px] border-transparent h-[900px] ${isDarkMode ? (isAlternateDarkMode ? 'bg-black' : 'bg-white') : 'bg-Home-background-color'}`}>
        ...
        <div className=" flex flex-row w-[90%] h-[60%]  mx-auto mt-[100px]">
          <div className="flex flex-col w-[90%] h-[70%]  my-auto">
            <h1 className="text-[48px]">Welcome to <span className='text-[#F197F4]'>Go</span><span className='text-[#2B3A63] '>CPT</span> BETA <br></br>Your Path to Effortless CPT Coding!</h1>
            <h2 className="w-[600px] h-[75px] text-[24px]">
          ...
          <div className="relative mt-[-40px] ml-[37px]" onClick={(e) => e.stopPropagation()}>
        <label className="relative inline-flex items-center cursor-pointer mr-[4px] mt-[40px] 2xl:mr-[40px]">
          ...
          <div
            ...
            peer peer-checked:after:translate-x-[65px]  
